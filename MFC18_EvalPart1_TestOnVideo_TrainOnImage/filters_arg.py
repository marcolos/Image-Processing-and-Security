...
def scoreFilter1(scoreMatrix, opHistory, score, opFilter, operator='equal'):
...
def scoreFilter2(scoreMatrix, opHistory, score, opFilter, operator='equal', maxPreviousOp=0):
    tmp = []
    result = []
    tmpMatrix = []
    match = False

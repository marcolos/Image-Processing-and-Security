...
A = CSVreader('./Reference/probejournaljoin.csv')
...
#print(C[0][1])
#print(data['operations'][j]['name'])

# Creo un file JSON
# filePathNameWExt = '/Users/andreasimioni/Desktop/piva/MFC18_EvalPart1_TestOnVideo_TrainOnImage/reference/camera/result' + str(example) +'.json'
totalProbes = []
probes = {}
tmpOperations = {}
for i in range(len(C2)):
